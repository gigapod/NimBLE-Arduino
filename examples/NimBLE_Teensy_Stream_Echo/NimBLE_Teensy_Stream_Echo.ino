/**
 *  NimBLE_Teensy_Stream_Echo Example:
 *
 *  A minimal example demonstrating NimBLEStreamServer on Teensy 4.1 +
 *  Murata Type 1YN. Echoes back any data received from BLE clients.
 *
 *  This is the simplest way to use the NimBLE Stream interface, showing
 *  just the essential setup and read/write operations.
 *
...
void setup() {
    Serial.begin(115200);
    Serial.println("NimBLE Teensy Stream Echo Server");
