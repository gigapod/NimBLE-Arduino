/**
 *  NimBLE_Teensy_Stream_Server Example:
 *
 *  Demonstrates using NimBLEStreamServer on Teensy 4.1 + Murata Type 1YN to
 *  create a BLE GATT server that behaves like a serial port using the
...
void setup() {
    Serial.begin(115200);
    Serial.println("Starting NimBLE Teensy Stream Server");
