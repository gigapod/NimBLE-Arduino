...
/** NimBLE_Teensy_Client Demo:
 *
 *  Demonstrates many of the available features of the NimBLE client library,
 *  on Teensy 4.1 + Murata Type 1YN.
 *
...
void setup() {
    Serial.begin(115200);
    Serial.printf("Starting NimBLE Teensy Client\n");
...
void loop() {
    /** Keep the BLE host alive -- no RTOS task does it for you on Teensy. */
