/**
 *  NimBLE_Teensy_Stream_Client Example:
 *
 *  Demonstrates using NimBLEStreamClient on Teensy 4.1 + Murata Type 1YN to
 *  connect to a BLE GATT server and communicate using the Arduino Stream
 *  interface.
 *
 ...
 *
 *  This example connects to the NimBLE_Teensy_Stream_Server example.
 *
...
void setup() {
    Serial.begin(115200);
    Serial.println("Starting NimBLE Teensy Stream Client");
