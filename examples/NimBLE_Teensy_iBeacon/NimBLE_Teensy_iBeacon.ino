/**
 *  NimBLE_Teensy_iBeacon example
 *
 *  This example demonstrates how to publish an Apple-compatible iBeacon on
 *  Teensy 4.1 + Murata Type 1YN. See src/nimble/teensy_port/README.md for
 *  wiring; nimble_port_teensy_pump() must be called every loop() iteration
 *  for the BLE host to run (no RTOS task does it for you on Teensy).
 */
...
void setup() {
    Serial.begin(115200);
    Serial.println("Starting NimBLE Teensy iBeacon");
